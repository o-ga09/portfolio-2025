...
```tsx
<Button className="bg-accent/90 hover:bg-accent/80 text-accent-foreground shadow-md">Label</Button>
```
...
```tsx
<span className="bg-secondary/50 text-secondary-foreground text-xs px-2 py-1 rounded">#tag</span>
```
